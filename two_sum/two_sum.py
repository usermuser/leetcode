...
class Solution(object):
    ...
    todo сделай проверку на количество чисел, если их два, то без цикла сложи и проверь.
        также сделай проверку на ограничения, если число пришло больше или меньше чем задано по условию.
    """
